    ...
    public static void init() {
        if (Settings.getLanguage().equals("ru")) {
            ...
            data.put("ABOUT", "<body style = 'font-size: 120%;  text-align : center ; width : 350px;'> "
                    ...
                    + "<p> Данная программа была сделана (AlexNK_RO)</p>"
                    + "<p> С Уважением , Алексей Наумов!</p>"
                    + "<br/><p><a style = font-weight: bold; 'href = 'https://github.com/AlexNka-Ro'>https://github.com/AlexNka-Ro<a/></p>"
